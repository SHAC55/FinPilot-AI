...
import {
  ...
  Shield, TrendingUp, Wallet, Eye, EyeOff, CheckCircle,
} from "lucide-react";
...
const Register = () => {
  ...
  const strengthIndex = getStrength(password);
  const strength = strengthConfig[strengthIndex];
    ...
    <div className="min-h-screen w-full flex bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-700 text-white p-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-white rounded-full filter blur-3xl" />
        </div>
        <div className="relative z-10 flex flex-col justify-between w-full">
          <div>
            ...
            <p className="text-lg text-blue-100 mb-12 leading-relaxed">
              Join thousands of users saving money and achieving their financial goals with AI-powered insights.
            </p>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/20 flex items-center gap-3">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm">Join FinPilot and take control of your finances</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="text-xs space-y-1">
                ...
                <p className={password?.match(/[A-Za-z]/) && password?.match(/\d/) ? "text-green-600" : "text-gray-400"}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-xl flex items-start gap-2">
