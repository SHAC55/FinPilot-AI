    ...
    <div className="w-full bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-xl transition-shadow duration-300 h-[170px] flex flex-col justify-between">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 leading-snug">
          <span className="font-bold text-green-700">5 bills</span> completed this month.
        </p>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 text-white text-xs font-medium shadow-md hover:shadow-lg transition-all duration-200">
          View
        </button>
      </div>
    </div>
