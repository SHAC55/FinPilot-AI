...
const GoalsHeader = () => {
  ...
  return (
    <div className='bg-blue-600 flex md:flex-row flex-col p-5 justify-between text-white pt-12'>
      <h1 className="text-2xl sm:text-3xl font-bold leading-snug">
       ...
       className="flex items-center md:mt- 0 mt-5 gap-2 bg-white text-indigo-600 px-5 py-2 md:rounded-full rounded-md font-semibold shadow-md hover:shadow-lg hover:bg-indigo-50 transition-all duration-300">
         <Plus size={20} />
         Add Goal
       </button>
    </div>
